...
- Not draggable, not connectable, no delete keybind — charting and layout stay desktop concerns.
...
- `./ChainDrawer` (`ChainDrawer`, `ChainCardList`)
...
- `ChainDistanceBadge`, `MobileChainCard` types from `@/types`
